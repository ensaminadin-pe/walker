...
const Position6 move_6_3_forward_walk_positions[] {
	...
	/* frame  1 */ {POSITION_OPTION_NONE,		0,		0,		{350.0, -600.0, 0.0},	{0, 0, 0},	{2.0, 2.1, 2.2},	{3.0, 3.1, 3.2},	{4.0, 4.1, 4.2},	{5.0, 5.1, 5.2}},
...
const Position1 move_6_3_test_positions[] {
	...
	/* frame  1 */ {POSITION_OPTION_NONE,		0,		0,		{350.0, -600.0, -60.0f}},
	/* frame  1 */ {POSITION_OPTION_NONE,		0,		0,		{350.0, -600.0, 0.0}}
};
Animation move_6_3_test {4, 1, ANIMATION_TYPE_MOVEMENT, (Position*)&move_6_3_test_positions[0]};
