...
const Position6 move_6_3_forward_walk_positions[] {
	...
	/* frame  1 */ {POSITION_OPTION_NONE,		0,		0,		{0.0, 0.1, 0.2},	{1.0, 1.1, 1.2},	{2.0, 2.1, 2.2},	{3.0, 3.1, 3.2},	{4.0, 4.1, 4.2},	{5.0, 5.1, 5.2}},
	/* frame  2 */ {POSITION_OPTION_NONE,		0,		0,		{10.0, 10.1, 10.2},	{11.0, 1.1, 1.2},	{12.0, 12.1, 12.2},	{13.0, 13.1, 13.2},	{14.0, 14.1, 14.2},	{15.0, 15.1, 15.2}},
	/* frame  3 */ {POSITION_OPTION_NONE,		0,		0,		{20.0, 20.1, 20.2},	{21.0, 1.1, 1.2},	{22.0, 22.1, 22.2},	{23.0, 23.1, 23.2},	{24.0, 24.1, 24.2},	{25.0, 25.1, 25.2}},
	/* frame  4 */ {POSITION_OPTION_NONE,		0,		0,		{30.0, 30.1, 30.2},	{31.0, 31.1, 31.2},	{32.0, 32.1, 32.2},	{33.0, 33.1, 33.2},	{34.0, 34.1, 34.2},	{35.0, 35.1, 35.2}},
	/* frame  5 */ {POSITION_OPTION_NONE,		0,		0,		{40.0, 40.1, 40.2},	{41.0, 41.1, 41.2},	{42.0, 42.1, 42.2},	{43.0, 43.1, 43.2},	{44.0, 44.1, 44.2},	{45.0, 45.1, 45.2}}
};
